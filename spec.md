...
| 18/9 (CP5 Hoàn thiện) | Nâng cấp bộ hiển thị slide PDF sang **Mozilla PDF.js Canvas Engine** (2 chế độ: "Theo trang" độc lập không bị thừa mép + "Cuộn dọc" liên tục) & Resizable Side Panel cho Trợ giảng AI. | Giải quyết triệt để điểm nghẽn người dùng: chống lạc trôi khi cuộn chuột và cho phép tùy biến độ rộng màn hình đọc bài giảng thoải mái. |
| 18/9 (CP5 Hoàn thiện) | Triển khai cơ chế Sư phạm **"Trả lời súc tích & Kéo về bài học"** (Pedagogical Bridge & Progressive Disclosure). | Khắc phục hiện tượng bot trả lời lan man triết học; chỉ cung cấp vi mô 1-2 câu cốt lõi và chủ động yêu cầu học viên tập trung quay lại giáo trình. |
| 18/9 (CP5 Hoàn thiện) | Ẩn danh hóa toàn diện tài khoản ("Học viên" - avatar `HV`) và kích hoạt nút **"✨ Đặt câu hỏi với AI"** trên Topbar. | Chuẩn hóa môi trường kiểm thử cho người dùng ngoài nhóm, tối đa hóa không gian đọc bài khi mặc định ẩn panel trợ lý. |
