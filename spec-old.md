...
- **Problem statement:**
  - *Học viên bị mất phương hướng khi tra cứu kiến thức giữa hàng trăm trang slide của 6 ngày học, trong khi bot hỗ trợ hiện tại chỉ phục vụ được đúng lab đang mở — mọi câu hỏi liên quan đến Day khác đều nằm ngoài phạm vi, khiến học viên phải tự lật slide thủ công.* (KHÔNG chứa chữ "AI").
...
- **Bot VLearn hiện tại (Scoped theo từng Day):**
  - *Đáng né:* Bot hiểu tốt nội dung lab đang mở — nhưng **scope bị khoá chặt trong ngày đó**. Học viên hỏi về khái niệm của Day khác là bot không biết, không dẫn được link, không kết nối được kiến thức liên buổi.
  - *Khác biệt của SHUP:* **Mở rộng và chia tầng (Expand & Layer)** — Bot Hỗ Trợ phá vỡ giới hạn Day-scope, định vị kiến thức xuyên 6 buổi; Bot Con giữ nguyên sức mạnh hiểu sâu trong từng Day nhưng có thêm slide + transcript đầy đủ.
- **NotebookLM:**
...
| 17/9 | Đính chính mô tả bot cũ tại §1, §3: bot hiện tại chỉ biết lab trong ngày + FAQ cố định, không phải monolithic RAG | Làm rõ đúng bản chất giới hạn của bot cũ để problem statement chính xác hơn, phản ánh đúng gap mà Hub & Spoke lấp đầy |